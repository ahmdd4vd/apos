...
完整流程保留在 [`skills/apos/SKILL.md`](./skills/apos/SKILL.md) 中。指令文件只需要包含简短的强制提醒：检查 `.apos/`、分类任务、执行验证、完成前运行 Finish Protocol、同步受影响的状态并提供 APOS Report。不要复制整个 skill，并保留已有指令。
...
- [`skills/apos/SKILL.md`](./skills/apos/SKILL.md) — coding agent 使用的主要指令。
